...
export default function LoginForm() {
  ...
  const [_rootErrors, setRootErrors] = useReducer(
  ...
  const mutation = useMutation({
    ...
    onError: () => {
      setRootErrors({ root: "Erro ao fazer login" })
    },
  })
  ...
  return (
    ...
    >
      {({ errors, touched, handleChange, isSubmitting, isValid }) => (
                        ...
                        <SvgIcon sx={{ width: 16, height: 16 }}>
                          ...
                          >
                            <path
                              ...
                              fill={theme.palette.black_19[300]}
                            />
                          </svg>
                        </SvgIcon>
                      </IconButton>
